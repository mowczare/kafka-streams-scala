...
import com.mowczare.kafka.streams.hll.model.{HllWrap, ItemSketchWrap}
...
class HllStreamTest extends FunSuite with Matchers {
  ...
  test("Sample test") {
    ...
    MockedStreams()
      ...
      .output[Long, ItemSketchWrap[InputEvent]](outputTestTopic, Serdes.Long, ItemSketchWrap.thetaSerde[InputEvent], 1000) shouldBe IndexedSeq.empty
  }
